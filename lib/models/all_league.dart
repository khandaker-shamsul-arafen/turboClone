class AllLeague {
  ...
  AllLeague.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Currentseason {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['tie_breaker_rule_id'] = this.tieBreakerRuleId;
    data['name'] = this.name;
    ...
    data['standings_recalculated_at'] = this.standingsRecalculatedAt;
    data['games_in_current_week'] = this.gamesInCurrentWeek;
    return data;
  }
}
